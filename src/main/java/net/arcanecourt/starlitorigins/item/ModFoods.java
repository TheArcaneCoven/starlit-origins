...
public class ModFoods {
    ...
    public static final FoodProperties ELDRITCH_STEW = (new FoodProperties.Builder()).nutrition(8).saturationMod(1.2f)
            .effect(() -> nourishment(2400), 1.0f).effect(new MobEffectInstance(MobEffects.ABSORPTION, 100, 2), 1.0f)
            .build();
    ...
    public static final FoodProperties BAKED_EMERALD_GINGERBREAD = new FoodProperties.Builder().nutrition(7).saturationMod(0.7f)
            .effect(new MobEffectInstance(MobEffects.HERO_OF_THE_VILLAGE, 120, 0), 0.1f)
            .build();
    ...
    public static final FoodProperties MINER_STEW = new FoodProperties.Builder().nutrition(6).saturationMod(0.6f).build();
    public static final FoodProperties GOLD_COATED_CALCITE_EGG = new FoodProperties.Builder().nutrition(6).saturationMod(0.6f).build();
